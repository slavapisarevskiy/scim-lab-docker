...
#curl -v -X GET --basic -u $(prop 'PINGFEDERATE_ADMIN_CREDENTIALS') --header 'Content-Type: application/json' --header 'X-XSRF-Header: PingFederate' $(prop 'PINGFEDERATE_ADMIN_BASEURL')/pf-admin-api/v1/bulk/export --insecure > ./out/pf-export.json
